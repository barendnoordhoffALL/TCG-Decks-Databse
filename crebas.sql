...
alter table COLOR
   drop constraint PK_COLOR;

drop table COLOR;

drop index FK_ONEPIECEDECK_STATUS_FK;

drop index FK_ONEPIECEDECK_SET_FK;

drop index ONEPIECEDECK_PK;

alter table ONEPIECEDECK
   drop constraint PK_ONEPIECEDECK;

drop table ONEPIECEDECK;

drop index FK_ONEPIECEDECK_COLOR_FK;

drop index FK_COLOR_ONEPIECEDECK_FK;

drop index ONEPIECEDECKCOLORS_PK;

alter table ONEPIECEDECKCOLORS
   drop constraint PK_ONEPIECEDECKCOLORS;

drop table ONEPIECEDECKCOLORS;

drop index FK_ONEPIECEDECK_TYPING_FK;

drop index FK_TYPING_ONEPIECEDECK_FK;

drop index ONEPIECEDECK_TYPINGS_PK;

alter table ONEPIECEDECK_TYPINGS
   drop constraint PK_ONEPIECEDECK_TYPINGS;

drop table ONEPIECEDECK_TYPINGS;

drop index SET_PK;

alter table SET
   drop constraint PK_SET;
...
drop index TYPING_PK;

alter table TYPING
   drop constraint PK_TYPING;
